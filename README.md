...
- v0.2.0: [Release notes](https://github.com/nobody-qwert/cline-local/releases/tag/v0.2.0) • [Download VSIX](https://github.com/nobody-qwert/cline-local/releases/download/v0.2.0/cline-local-0.2.0.vsix)
