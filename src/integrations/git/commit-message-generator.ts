...
async function performCommitGeneration(context: vscode.ExtensionContext, gitDiff: string, inputBox: any) {
	try {
		vscode.commands.executeCommand("setContext", "clineLocal.isGeneratingCommit", true)
...
Commit message:`
		...
		vscode.commands.executeCommand("setContext", "clineLocal.isGeneratingCommit", false)
	}
}
